...
# tests/docker/suite.zsh inside it: cargo build/test (the zle-integration tests
# among them) plus the headless zsh suites (keybinds.zsh, vectors.zsh,
# transport.zsh). CI's Linux matrix calls exactly this script, so a CI failure
